...
Add back carbon tax revenue. We estimated weighted income deciles above and mapped number of households by decile. We divided the revenue by that number and we add that amount by the first four income deciles in this manner. Again, another one calculated in Excel because of time constraints. Needs fixing.
...
ic_microsim <- ic_microsim %>% 
  mutate(
    totalinc_2030_nzs = 
      case_when(
        income_decile_group == 1 ~ totalinc_2030_nzs_noctr + 10934.510475,
        income_decile_group == 2 ~ totalinc_2030_nzs_noctr + 10923.532151,
        income_decile_group == 3 ~ totalinc_2030_nzs_noctr + 10949.535283,
        income_decile_group == 4 ~ totalinc_2030_nzs_noctr + 10930.087743,
        .default = totalinc_2030_nzs_noctr
      )
  )
```
...
new_poor_map <- adm1 %>%
  ...
  mutate(
    ...
    new_poor_dry_hot_food2_pct = new_p_lab_cc_foodPI /
         total_population * 100,
