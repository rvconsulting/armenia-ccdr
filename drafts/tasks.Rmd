...
To improve the narrative, invert the sign of the loss (this is how many people would get out of poverty if measures to prevent flood damage were in place, as floods are already happening).
For perspective on the poor and non-poor, show the share that the loss represents out of total consumption.
Keep this and then do 100 year floods (no NPV but just monthly and poverty).
...
Just to make sure, for the 100 years flood, you can keep this as a negative shock. We want to see what would happen if tomorrow each Marz was struck by the 100 years flood.
...
The average share of losses (as a share of consumption of the people affected) per marz for housing, agriculture, and for both housing and agriculture combined
The number of people that could get out of poverty if there was no flood, per marz, for housing and agriculture combined
The number of people with dilapidated houses that are exposed to floods, per marz
